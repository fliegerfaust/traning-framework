...
$urlconf = array(
  '' => array('module' => 'front'),
  '/^admin$/' => array('module' => 'admin', 'auth' => 'auth_admins'),
  '/^admin\/(\d+)$/' => array('module' => 'admin', 'auth' => 'auth_admins'),
  '/^user_management$/' => array('module' => 'user_management', 'auth' => 'auth_basic'),
  '/^form$/' => array('module' => 'form'),
  '/^form_edit$/' => array('module' => 'form_edit', 'auth' => 'auth_as_session'),
  '/^login$/' => array('module' => 'login'),
  '/^logout$/' => array('module' => 'logout'),
  '/^webservice\/admin$/' => array('module' => 'webservice_admin', 'auth' => 'auth_admins'),
  '/^webservice\/admin\/xmlForm(\d+)$/' => array('module' => 'webservice_admin', 'auth' => 'auth_admins'),
  '/^webservice$/' => array('module' => 'webservice', 'auth' => 'auth_webservice'),
